...
- Phase 3 features: combine-bt virtual sink (dual BT speakers), ducking engine (auto-duck Spotify for video/sound), routing inheritance (command > cue > global target resolution)

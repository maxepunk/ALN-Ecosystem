...
| 20 | ALN-Ecosystem (parent) **#34** (draft, opened 2026-09-05 at unit open) + ALNScanner **#16** (draft, stacked on #15, opened 2026-09-06 at S2 close) | fix vehicle | `claude/phase3-train-fixes` (both repos) | The whole-train review's fix vehicle (all 8 MAJORs + the ruled fix-now set; full triage: `2026-09-05-train-fix-vehicle.md`; estimate signed 2026-09-05). Scanner #16 merges with #15's group; parent #34 carries the submodule pin to #16's head. Walked LAST. |

...
(Q1+Q2+Q3+Q5+Q-3b-1 — closes slices 3a and 3b entirely; branch
`claude/phase3-a3-closers`) → (ii) **slice 4** (now unblocked; needs the
in-repo fully-bound ALN installation profile per ratified C1) → (iii)
slice 6 (recon paused for the closers) → slice 7 → theme unit → B0.

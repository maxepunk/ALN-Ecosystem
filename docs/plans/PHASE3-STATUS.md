...
| 20 | ALN-Ecosystem (parent) + a NEW ALNScanner PR (stacked on #15) | fix vehicle — PR opens at unit open | `claude/phase3-train-fixes` | The whole-train review's fix vehicle (all 8 MAJORs + the ruled fix-now set; full triage: `2026-09-05-train-fix-vehicle.md`). Build gate HELD on the owner's estimate signature. Walked LAST. |

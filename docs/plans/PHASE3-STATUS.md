...
| L8 | *(reserved — lands at S4 with the migrated ENDGAME `target:"bluetooth"` audio literal [post-Phase-3: checkpoint at the pack-manager media page, ROADMAP §8.2 — owner-ratified 2026-08-29])* | see slice-4 design doc D-4.6/OQ7 | lands with the S4 pack authoring |

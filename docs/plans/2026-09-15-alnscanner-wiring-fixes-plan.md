...
- **Evidence:** 2026-05-23 game night: 20 VLC exit/restart + 16 "Timeout waiting for video" entries; 2026-04-17 cut; 2026-07-18 clean. `--vout=gles2` with the full production arguments PLAYS on the bench's headless Xorg (probed 2026-09-15) — do NOT set `VLC_HW_ACCEL` in TEST_ENV; an empty value drops gles2 and at the venue that is the 280%-CPU/black-screen regression.

...
test.describe('GM Scanner - Environment Control', () => {
  ...
  test('GM controls music playback', async () => {
    ...
    try {
      ...
      // auto-starts playback per musicService.loadPlaylist).
